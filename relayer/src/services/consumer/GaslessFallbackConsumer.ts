...
import { EVMRawTransactionType, GaslessFallbackTransactionMessageType, TransactionType } from '../../../../common/types';
...
import { GaslessFallbackConsumerParamsType } from './types';
...
ITransactionConsumer<IEVMAccount, EVMRawTransactionType> {
  ...
  private queue: IQueue<GaslessFallbackTransactionMessageType>;
