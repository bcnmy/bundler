...
import { entryPointMap, bundlerSimulatonServiceMap } from '../../../common/service-manager';
  ...
  try {
    ...
    if (dappAPIKey === 'nJPK7B3ru.dd7f7861-190d-41bd-af80-6877f74b8f44') {
      if (
        ...
        return {
          code: -32400,
          message: 'Request to mainnet not allowed. Please reach out and request a mainnet Bundler URL',
        };
      }
    }
