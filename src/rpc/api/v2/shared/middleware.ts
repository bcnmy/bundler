        ...
        default:
          ...
          return res.status(STATUSES.BAD_REQUEST).send({
            ...
            error: {
              ...
              message: `JSON RPC Method: ${method} not suported by the Bund;er`,
            },
          });
      }
