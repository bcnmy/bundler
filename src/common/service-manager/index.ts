  ...
  for (const chainId of supportedNetworks) {
    ...
    for (const relayerManager of config.relayerManagers) {
      if (
        ...
        [
          97, 56, 1442, 1101, 42161, 42170, 420, 10, 43113,
          43114, 84531, 8453, 59140, 59144, 5000, 5001, 204, 5611, 88888, 592, 88882,
          81, 1115, 1116, 169, 3441005, 91715, 7116, 9980, 421614, 11155111
        ].includes(chainId)
      ) {
