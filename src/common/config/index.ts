...
export function mergeWithDecryptedConfig(
  ...
  if (decryptedConfig.relayerManager) {
    merged.relayerManager.relayerSeed =
    decryptedConfig.relayerManager.relayerSeed;

  merged.relayerManagers.ownerAddress =
    decryptedConfig.relayerManager.ownerAddress;

  merged.relayerManager.ownerPrivateKey =
    decryptedConfig.relayerManager.ownerPrivateKey;
  } else {
