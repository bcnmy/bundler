...
export class MaticGasPrice extends GasPrice implements IScheduler {
  ...
  //       log.error(`[MATIC GAS STATION] Error in fetching gas price
  //       from matic gas station. ${err}`);
  ...
  //     // so when its used to bump up gas price,
  //     it doesn't end up in "transaction underpriced" error
  ...
  //       log.info(`Fast gas price for matic ${fastGasPriceInWei}
  //      is more than ${upperLimit} gwei`);
  //       fastGasPriceInWei = upperLimit;
  //     }
  //     if (fastestGasPriceInWei > upperLimit) {
  //       log.info(`Fast gas price for matic ${fastestGasPriceInWei}
  //       is more than ${upperLimit} gwei`);
  //       fastestGasPriceInWei = upperLimit;
  //     }
  //     if (mediumGasPriceInWei > upperLimit) {
  //       log.info(`Fast gas price for matic ${mediumGasPriceInWei}
  //      is more than ${upperLimit} gwei`);
