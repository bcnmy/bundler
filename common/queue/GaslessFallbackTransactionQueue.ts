...
import { GaslessFallbackTransactionMessageType, TransactionType } from '../types';
...
export class GaslessFallbackTransactionQueue implements
IQueue<GaslessFallbackTransactionMessageType> {
  ...
  async publish(data: GaslessFallbackTransactionMessageType) {
