...
import { FallbackGasTankDepositTransactionMessageType, TransactionType } from '../types';
...
export class FallbackGasTankDepositTransactionQueue implements
IQueue<FallbackGasTankDepositTransactionMessageType> {
  private channel!: Channel;

  transactionType: TransactionType = TransactionType.FALLBACK_GASTANK_DEPOSIT;
  ...
  async publish(data: FallbackGasTankDepositTransactionMessageType) {
